...
function [ax,posAxisPSTH,raster,PSTH_avg,PSTH_se,h2] = gngRaster4odorV2_Nrp_grant(tsp, odor, onset_ts, premsec,postmsec, blockID)
...
if ~isempty(data)
    ...
    ax=subplot(3,lownum,plotnum+lownum+4);
