function [H, cost,loadings,power] = seqNMF_Fit(X,W, varargin)
% This code is modified from the seqNMF packages to calculate H when W is
% fixed
% Li Yuan, 2025-Feb
% USAGE: 
% 
...
[X,N,T,K,L,params] = parse_seqNMF_params_2(X,W,varargin);

%% initialize
W2 = params.W_init;
H = params.H_init;

Xhat = helper.reconstruct(W2, H); 
...
% end
    ...
    function [X,N,T,K,L,params] = parse_seqNMF_params_2(X,W,inputs)
