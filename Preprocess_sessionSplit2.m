...
% Li YUAN, 2026-Mar
% The split switch changed to pull down circuit
% Li YUAN, 2026-Apr
function Preprocess_sessionSplit2(inFile,analyzeSes)
close all
p.saveFile = 1;
...
for sessInd = analyzeSes(1:end)
    ...
    if ~isempty(IO_type)
        ...
        switchSig = behaveData(splitIndicator,:) < 0.2;
    ...
    if p.saveFile
        ...
        save(fullfile(sessInfo(sessInd).npx_path,'behaviorBlocks.mat'), 'behaviorBlocks','-v7.3');
    end
